...
ᴀɴꜱʜ ᴇʟɪꜱᴀ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ`,
  ...
  PORT: 3000,
  BOT_NAME: '𝐀𝐍𝐒𝐇 𝐄𝐋𝐈𝐒𝐀',
  OWNER_NAME: 'ᴍ ʀ  ᴀ ɴ ꜱ ʜ',
  OWNER_NUMBER: '233535954754',
  SUDO: '233535954754',
  WORK_TYPE: 'public',
  WORK_MODE: 'group',
  TIME_ZONE: 'Asia/Colombo',
  CAPTION: '© ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ᴀɴꜱʜ ᴇʟɪꜱᴀ ᴍᴅ',
  STICKER_AUTHOR: 'ᴀɴꜱʜ ᴇʟɪꜱᴀ',
  STICKER_PACK: 'ᴍʀ ᴀɴꜱʜ ᴏꜰᴄ',
  REMOVE_BG_APIKEY: '',
  MAXIMUM_FILESIZE: 90,
  OWNER_R_EMOJI: '💻',
  ALIVE_AS_GIF: true,
